...
import {BinaryFileAPI} from './BinaryFileAPI';
import {DataAPI} from './DataAPI';
import {DataFileAPI} from './DataFileAPI';
import {DocumentFileAPI} from './DocumentFileAPI';
import {ExecutableFileAPI} from './ExecutableFileAPI';
...
import {InteractiveFileAPI} from './InteractiveFileAPI';
import {LocationAPI} from './LocationAPI';
import {MusicFileAPI} from './MusicFileAPI';
import {PathCompletionAPI} from './PathCompletionAPI';
import {PublishAPI} from './PublishAPI';
import {TagAPI} from './TagAPI.ts';
import {StatisticsAPI} from './StatisticsAPI';
import {ThumbFileAPI} from './ThumbFileAPI';
...
export {BinaryFileAPI} from './BinaryFileAPI';
export {DataAPI} from './DataAPI';
export {DataFileAPI} from './DataFileAPI';
export {DocumentFileAPI} from './DocumentFileAPI';
export {ExecutableFileAPI} from './ExecutableFileAPI';
export {FileContentAPI} from './FileContentAPI';
...
export const binaryFileAPI = new BinaryFileAPI(apiUrl, '/files/binary');
export const dataAPI = new DataAPI(apiUrl, '/data-publish');
export const dataFileAPI = new DataFileAPI(apiUrl, '/files/data');
export const documentFileAPI = new DocumentFileAPI(apiUrl, '/files/document');
export const executableFileAPI = new ExecutableFileAPI(apiUrl, '/files/executable');
export const fileContentAPI = new FileContentAPI(apiUrl, '/files');
...
export const interactiveFileAPI = new InteractiveFileAPI(apiUrl, '/files/interactive');
export const locationAPI = new LocationAPI(apiUrl, '/location');
export const musicFileAPI = new MusicFileAPI(apiUrl, '/files/music');
...
export const tagAPI = new TagAPI(apiUrl, '/tags');
export const statisticsAPI = new StatisticsAPI(apiUrl, '/statistics');
export const thumbFileAPI = new ThumbFileAPI(apiUrl, '/files/thumb');
